...
test("array literal syntax and indexing", function() {
    ...
    equal(true === true, favouriteThings[0], 'what is in the first position of the array?');
    equal(1 === 1 === true, favouriteThings[1], 'what is in the second position of the array?');
    equal(1 == '1' === true, favouriteThings[2], 'what is in the third position of the array?');
});
